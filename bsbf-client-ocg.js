function bsbf_client_ocg(server_ipv4, server_port, uuid, ocg_args) {
  ...
  for (const arg of ocgArgs) {
    switch (arg) {
      case "--dongle-modem":
        packages += " bsbf-autoconf-dhcp kmod-usb-net-cdc-ether usb-modeswitch";
        break;
      case "--mbim-modem":
        packages += " bsbf-autoconf-cellular bsbf-quectel-usbnet kmod-usb-serial-option umbim";
        break;
      case "--usb-adapters-and-android-tethering":
        packages += " bsbf-autoconf-dhcp kmod-usb-net-cdc-ether kmod-usb-net-rtl8152 kmod-usb-net-rndis";
        break;
      case "--ios-tethering":
        packages += " bsbf-autoconf-dhcp kmod-usb-net-ipheth usbmuxd";
        break;
      case "--mikrotik-tools":
